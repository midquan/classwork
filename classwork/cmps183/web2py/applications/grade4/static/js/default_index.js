...
var app = function() {
    ...
    self.get_users = function () {
     ...
     self.get_images_from_user = function(user_email) {
    ...
    self.get_images_from_other = function(user_email) {
    ...
    self.price = function(image_idx) {
        var um = self.vue.user_images[image_idx];
        console.log("set price function called");
        $.post(price_url,
            {
                image_id: um.id,
                price: um.price,
    ...
    self.buy = function () {
        self.stripe_instance.open({
            name: "Checkout",
            description: "Enter your address and card",
        ...
        $.post(purchase_url,
            ...
            function (data) {
                if (data.result === "ok") {
                    ...
                    $.web2py.flash("Thank you");
                } else {
                    $.web2py.flash("Card declined.");
                }
            }
        );
    };
    ...
    self.vue = new Vue({
        ...
        methods: {
            ...
            get_images_from_user: self.get_images_from_user,
            get_images_from_other: self.get_images_from_other,
            price: self.price,
